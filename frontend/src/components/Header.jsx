      ...
      <div className="mx-auto max-w-7xl px-6 py-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={`flex h-9 w-9 items-center justify-center rounded-md ring-1 transition-colors ${
              theme === 'dark' 
              ...
              <svg 
                ...
                className={`h-7 w-7 transition-colors ${
                  theme === 'dark' ? 'fill-slate-300' : 'fill-slate-700'
                }`}
              >
          ...
          <nav className="flex items-center gap-6">
            <a className={`hidden sm:block text-sm transition-colors ${
              theme === 'dark' 
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-md px-3 py-1.5 text-sm ring-1 transition-all hover:scale-105 ${
                theme === 'dark'
                  ? 'bg-white/[0.03] ring-white/10 text-slate-200 hover:bg-white/[0.06] hover:ring-white/20'
                  : 'bg-white ring-slate-300 text-slate-700 hover:bg-slate-50 hover:ring-slate-400'
              }`}
